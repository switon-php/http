...
Security fixes are provided for **currently supported release lines** of `switon/http` (`switon/http` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/http/security/advisories/new)
